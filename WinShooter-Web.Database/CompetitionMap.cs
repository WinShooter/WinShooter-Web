...
namespace WinShooter.Database
{
    ...
    public class CompetitionMap : ClassMap<Competition>
    {
        ...
        public CompetitionMap()
        {
            ...
            this.HasMany(x => x.Parameters).KeyColumn("CompetitionId").Cascade.AllDeleteOrphan();
            this.HasMany(x => x.Shooters).KeyColumn("CompetitionId").Cascade.AllDeleteOrphan();
            this.HasMany(x => x.Patrols).KeyColumn("CompetitionId").Cascade.AllDeleteOrphan();
            this.HasMany(x => x.Stations).KeyColumn("CompetitionId").Cascade.AllDeleteOrphan();
            this.HasMany(x => x.UserRoleInfos).KeyColumn("CompetitionId").Cascade.AllDeleteOrphan();
