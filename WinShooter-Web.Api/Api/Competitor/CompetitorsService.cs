// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CompetitorsService.cs" company="Copyright ©2014 John Allberg & Jonas Fredriksson">
...
namespace WinShooter.Api.Api.Competitor
{
    ...
    /// The competitors service.
    /// </summary>
    public class CompetitorsService : Service
    {
        /// <summary>
        /// The log.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompetitorsService"/> class.
        /// </summary>
        public CompetitorsService()
        {
            this.log = LogManager.GetLogger(this.GetType());
            this.databaseSession = NHibernateHelper.OpenSession();
            this.logic = new CompetitorsLogic(this.databaseSession);
        }
