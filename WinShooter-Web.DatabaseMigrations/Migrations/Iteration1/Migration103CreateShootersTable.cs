// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Migration103CreateShootersTable.cs" company="Copyright ©2014 John Allberg & Jonas Fredriksson">
...
namespace WinShooter.Web.DatabaseMigrations.Migrations.Iteration1
{
    ...
    public class Migration103CreateShootersTable : Migration
    {
        ...
        public override void Up()
        {
            ...
            this.Create.PrimaryKey(string.Format("PK_{0}", ShootersTableName))
                .OnTable(ShootersTableName)
                .Column("Id")
                .Clustered();
        }
