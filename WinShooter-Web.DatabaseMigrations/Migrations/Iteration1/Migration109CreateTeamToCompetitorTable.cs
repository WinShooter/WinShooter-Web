// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Migration109CreateTeamToCompetitorTable.cs" company="Copyright ©2014 John Allberg & Jonas Fredriksson">
...
namespace WinShooter.Web.DatabaseMigrations.Migrations.Iteration1
{
    ...
    public class Migration109CreateTeamToCompetitorTable : Migration
    {
        ...
        public override void Up()
        {
            ...
            this.Create.PrimaryKey(string.Format("PK_{0}", TeamToCompetitorTableName))
                .OnTable(TeamToCompetitorTableName)
                .Column("Id")
                .Clustered();
        }
