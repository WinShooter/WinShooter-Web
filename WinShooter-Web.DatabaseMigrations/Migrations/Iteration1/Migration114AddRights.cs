// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Migration114AddRights.cs" company="Copyright ©2013 John Allberg & Jonas Fredriksson">
...
namespace WinShooter.Web.DatabaseMigrations.Migrations.Iteration1
{
    ...
    /// </summary>
    [Migration(114)]
    public class Migration114AddRights : Migration
    {
        /// <summary>
        ...
        {
            this.Execute.EmbeddedScript("Migration114AddRights.sql");
        }
